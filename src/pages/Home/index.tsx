...
const Home = () => {
  const imagesSlider = [
    <img src="/tree.png" alt="anh tu thien" className="h-[438px]" />,
    <img src="/hienmau.png" alt="anh tu thien" className="h-[438px]" />,
    <img src="/lantoayeuthuong.png" alt="anh tu thien" className="h-[438px]" />,
  ];
        ...
        <div className="w-1/2 flex gap-8 mx-auto">
          ...
          <div className="flex-1">
            ...
            <Typo className='text-justify'>
              Mercy Collection là nền tảng tổ chức quản lý các hoạt động thiện nguyện, nền tảng gây quỹ cộng đồng trực tuyến tiện
              ...
              Operation Smile DaNang, Quỹ Vì Tầm Vóc Việt, Pan Nature, Mạng Lưới Ung
              Thư Vú Việt Nam, Trung tâm hợp tác phát triển Trung Bộ và nhiều tổ
              chức khác. <br />
